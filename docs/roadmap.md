...
| **W11** | BPMN-expert AI editing — full capability set (move/reassign lane, reconnect, all task/gateway types, sub-process, conditional/default flows, event defs, data objects, layout, soundness validation) | `ai-advisor-engineer` + `canvas-engineer` | 🔄 audit + phased plan (`docs/superpowers/specs/2026-06-21-bpmn-editing-capabilities.md`); Phase 1 next |
